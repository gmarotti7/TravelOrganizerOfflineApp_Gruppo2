            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      hint: const Text('. . .'),
                      items: [
                        DropdownMenuItem(value: 'Da pagare', child: Row(children: const [Icon(Icons.circle, color: Colors.red, size: 14), SizedBox(width: 8), Text('Da pagare')])),
                        DropdownMenuItem(value: 'Pagata', child: Row(children: const [Icon(Icons.circle, color: Colors.green, size: 14), SizedBox(width: 8), Text('Pagata')])),
                      ],
                      onChanged: (valore) => setState(() => _statoSelezionato = valore),
                    ),
                  ),
                ],
              ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'GG/MM/AAAA', errorText: _erroreData,
                  filled: true, fillColor: Colors.white,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'HH:MM', errorText: _erroreOra,
                  filled: true, fillColor: Colors.white,
                  contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 12),
                  enabledBorder: const OutlineInputBorder(borderSide: BorderSide(color: Colors.black, width: 2), borderRadius: BorderRadius.zero),
                  focusedBorder: const OutlineInputBorder(borderSide: BorderSide(color: Colors.black, width: 3), borderRadius: BorderRadius.zero),
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (valore) => setState(() => _metodoPagamento = valore),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: ['EUR', 'USD', 'GBP', 'JPY', 'CHF'].map((valuta) => DropdownMenuItem(value: valuta, child: Text(valuta, style: const TextStyle(fontWeight: FontWeight.bold)))).toList(),
                      onChanged: (valore) {
                        if (valore != null) setState(() => _valutaSelezionata = valore);
                      },
                    ),
                  ),
                ],
